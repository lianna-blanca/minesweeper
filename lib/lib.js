...
function initBoard () {
  ...
  displayMessage("The SPCA\'s cat cages were left unlocked last night. Lucky for us, all the cats are asleep. Find them before they wake up!")
...
function showCell (evt) {
  ...
  if (evt.target.classList.contains('mine')) {
    var loseSound = document.getElementsByClassName("lose")[0];
    loseSound.play();
    lib.displayMessage('You got scratched!')
    revealMines()
    removeListeners()
    return
  }
